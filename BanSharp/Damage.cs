    ...
    public static class Damage
    {
        ...
        static Damage()
        {
            ...
            p = new PassiveDamage
            {
                ...
                GetDamage = (source, target) =>
                {
                    float dmg = (float)source.CalcDamage(target, BanSharp.Damage.DamageType.Magical, (target.MaxHealth - target.Health) * (5 + Math.Floor(source.AbilityPower() / 100) * 2.2f) / 100);
