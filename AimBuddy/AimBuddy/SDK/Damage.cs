    ...
    public static class Damage
    {
        ...
        static Damage()
        {
            ...
            p = new PassiveDamage
            {
                ...
                GetDamage = (source, target) =>
                {
                    float dmg = (float)source.CalcDamage(target, AimBuddy.SDK.Damage.DamageType.Magical, (target.MaxHealth - target.Health) * (5 + Math.Floor(source.AbilityPower() / 100) * 2.2f) / 100);
			...
			p = new PassiveDamage
            {
                ...
                GetDamage = (source, target) => (float)source.CalcDamage(target, DamageType.Physical, new int[] { 30, 45, 60, 75, 90, 105, 120, 135, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240 }[source.Level - 1] + (source.BaseAttackDamage + source.FlatPhysicalDamageMod) * 0.5f)
            };
            AttackPassives.Add(p);
            #endregion
            ...
            bool includePassive = false)
        {
	        ...
	        var k = source.BaseSkinName == "Kalista" ? 0.9d : 1d;
